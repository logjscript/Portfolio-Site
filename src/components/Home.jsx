    ...
    return (
        <div name='home' className='w-full h-screen bg-gray-50'>
            <div className='max-w-[1000px] mx-auto px-8 sm:px-16 flex flex-col justify-center h-full'>
                ...
                <p className='text-[#808bab] text-lg sm:text-xl py-4 max-w-[700px]'>I am a self-taught developer looking for my first role in the industry. I began coding a year and a half ago and have focused on building quick and responsive apps with eye-appealing user-interface. </p>
